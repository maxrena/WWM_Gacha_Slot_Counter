...
1. **Check Local skills**: Run `ls -d .agent/skills/firebase-basics` or `ls -d .agents/global-skills/firebase-basics`. If the directory exists, the skills are already installed locally.
