...
```bash
node .agents/global-skills/impeccable/scripts/live.mjs
```
...
```
LOOP:
  node .agents/global-skills/impeccable/scripts/live-poll.mjs   # default long timeout; no --timeout=
...
```
node .agents/global-skills/impeccable/scripts/live-poll.mjs --stream   # stays running; one JSON line per event
...
```bash
node .agents/global-skills/impeccable/scripts/live-status.mjs
node .agents/global-skills/impeccable/scripts/live-resume.mjs --id SESSION_ID
node .agents/global-skills/impeccable/scripts/live-complete.mjs --id SESSION_ID
```
...
```bash
node .agents/global-skills/impeccable/scripts/live-insert.mjs --id EVENT_ID --count EVENT_COUNT --position after \
...
```bash
node .agents/global-skills/impeccable/scripts/live-wrap.mjs --id EVENT_ID --count EVENT_COUNT --element-id "ELEMENT_ID" --classes "class1,class2" --tag "div" --text "TEXT_SNIPPET"
```
...
```bash
node .agents/global-skills/impeccable/scripts/live-poll.mjs --reply EVENT_ID done --file RELATIVE_PATH
```
...
```bash
node .agents/global-skills/impeccable/scripts/live-poll.mjs --reply EVENT_ID error "Short reason"
```
...
```bash
node .agents/global-skills/impeccable/scripts/live-poll.mjs --reply EVENT_ID steer_done ["Optional short note for a browser toast"]
```
...
```bash
node .agents/global-skills/impeccable/scripts/live-server.mjs stop
```
...
```bash
node .agents/global-skills/impeccable/scripts/detect-csp.mjs
```
